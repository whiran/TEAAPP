            ...
            <div className="min-h-screen bg-gray-100 dark:bg-gray-900 pt-[60px] flex items-center justify-center p-6">
                <div className="text-center max-w-2xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 text-left">
                        {[
                            { icon: '📋', title: 'Estate Registry', desc: 'Full list of registered estates with boundary polygons and owner details' },
                            { icon: '👷', title: 'Worker Management', desc: 'Workforce rosters, attendance tracking and productivity metrics' },
                            { icon: '🌿', title: 'Plot Management', desc: 'Tea land parcels, variety records, soil data and plucking schedules' },
                        ].map(f => (
